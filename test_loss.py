...
import h5py
with h5py.File('./data/testdata.mat', 'r') as f:
    f.keys() # matlabdata.mat 
test_x = h5py.File('./data/testdata.mat')['testdata'].value
with h5py.File('./data/testlabel.mat', 'r') as f:
    f.keys()
test_y = h5py.File('./data/testlabel.mat')['testlabel'].value
...
vhnet.load_state_dict(torch.load('vh_params.pkl'))  #, map_location='cpu'
pred_pro=[]
pred_y=[]
